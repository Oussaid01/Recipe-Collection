...
<!-- navBar -->
<nav class="navBar">
    <span class="navBar-title">Recipe Collection</span>
    <a href="home.php" class="btn recipies">
    Recipies
    ...
    <a class="btn" href="collection.php">Collection</a>
    <?php 
        if ($admin == "0"){
            echo '
                <a class="btn myprofile" href="profile.php">
                    My Profile
            ...
            echo '
                <a class="btn myprofile" href="admin.php">
    Admin Panel
